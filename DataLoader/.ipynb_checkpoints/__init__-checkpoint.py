...
class DatasetSplitter:
    ...
    def split_dataset_by_index(self, dataset, targets, val_target = 74):
...
class CustomDataLoader:
    def __init__(self, data, targets, batch_size=32, num_batches=100, subsample_size = 800, dimension=0, shuffle=True):
        self.data = data
    ...
    def __getitem__(self, batch_index):
        ...
        for label in self.labels[batch_index]:
            ...
            # Create variants for the same label by different subsampling
